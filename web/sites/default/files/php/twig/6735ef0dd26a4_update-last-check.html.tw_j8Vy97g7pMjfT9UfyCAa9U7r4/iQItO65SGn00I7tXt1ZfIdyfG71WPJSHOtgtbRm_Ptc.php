...
class __TwigTemplate_2ef7742284e8c81f1d220e64d50b4bea extends Template
{
  ...
  ";
        ...
        if (($context["last"] ?? null)) {
            // line 18
            yield "    ";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(t("Last checked: @time ago", ["@time" => $this->sandbox->ensureToStringAllowed(($context["time"] ?? null), 18, $this->source)]));
            yield "
  ";
        } else {
            // line 20
...
";
    ...
    {
        return new Source("", "core/modules/update/templates/update-last-check.html.twig", "C:\\xampp\\htdocs\\test_drupal_site\\web\\core\\modules\\update\\templates\\update-last-check.html.twig");
    }
