...
class __TwigTemplate_ba0727b18f3d4108b6d915340ef724b1 extends Template
{
    ...
    <div";
            // line 22
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["region_attributes"] ?? null), "first", [], "any", false, false, true, 22), "addClass", ["col-sm-6"], "method", false, false, true, 22), 22, $this->source), "html", null, true);
            yield ">
      ";
            // line 23
    ...
    <div";
            // line 26
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["region_attributes"] ?? null), "second", [], "any", false, false, true, 26), "addClass", ["col-sm-6"], "method", false, false, true, 26), 26, $this->source), "html", null, true);
            yield ">
      ";
            // line 27
...
";
    ...
    {
        return new Source("", "themes/contrib/bootstrap_barrio/layouts/col2-equal.html.twig", "C:\\xampp\\htdocs\\test_drupal_site\\web\\themes\\contrib\\bootstrap_barrio\\layouts\\col2-equal.html.twig");
    }
